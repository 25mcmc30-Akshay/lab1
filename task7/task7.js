...
var cityInput = input;
var getWeatherBtn = button;
var resultDiv = result;
var API_KEY = "54d732aae3775320fc5cc741b35baa3d";
/* ---------------- LOGIC ---------------- */
...
function getWeather(city) {
    return __awaiter(this, void 0, void 0, function () {
        var response, errorData, data, _a;
...
function showError(message) {
    resultDiv.innerHTML = "<p style=\"color:red\">".concat(message, "</p>");
}
